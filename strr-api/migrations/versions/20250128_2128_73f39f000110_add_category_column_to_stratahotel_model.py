...
def upgrade():
    stratahotelcategory = postgresql.ENUM('CATEGORY_1', 'CATEGORY_2', 'CATEGORY_3', name='stratahotelcategory')
    ...
    with op.batch_alter_table('strata_hotels', schema=None) as batch_op:
        batch_op.add_column(sa.Column('category', sa.Enum('CATEGORY_1', 'CATEGORY_2', 'CATEGORY_3', name='stratahotelcategory'), nullable=False))
    ...
    with op.batch_alter_table('strata_hotels_history', schema=None) as batch_op:
        batch_op.add_column(sa.Column('category', sa.Enum('CATEGORY_1', 'CATEGORY_2', 'CATEGORY_3', name='stratahotelcategory'), autoincrement=False, nullable=False))
