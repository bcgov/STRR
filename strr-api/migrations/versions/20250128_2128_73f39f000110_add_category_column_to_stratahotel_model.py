...
def upgrade():
    ...
    with op.batch_alter_table('strata_hotels', schema=None) as batch_op:
        batch_op.add_column(sa.Column('category', sa.Enum('FULL_SERVICE', 'MULTI_UNIT_NON_PR', 'POST_DECEMBER_2023', name='stratahotelcategory'), nullable=False))
    ...
    with op.batch_alter_table('strata_hotels_history', schema=None) as batch_op:
        batch_op.add_column(sa.Column('category', sa.Enum('FULL_SERVICE', 'MULTI_UNIT_NON_PR', 'POST_DECEMBER_2023', name='stratahotelcategory'), autoincrement=False, nullable=False))
