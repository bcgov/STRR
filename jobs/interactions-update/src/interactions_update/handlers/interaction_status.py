...
class InteractionStatusHandler:
    ...
    @classmethod
    def map_to_interaction_status(
        cls, normalized_status: str | None
        ...
        """
        if normalized_status == cls.DELIVERED_STATUS:
    ...
    def build_recipient_metadata(
        ...
        failure_type = (
            normalized_status if normalized_status in cls.FAILURE_STATUSES else None
        )
